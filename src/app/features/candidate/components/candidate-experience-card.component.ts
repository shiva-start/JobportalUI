  ...
  template: `
    <div class="bg-white rounded-xl shadow-sm p-4 sm:p-6">
      <div class="mb-5 flex items-center justify-between">
        <h2 class="font-bold text-gray-900">Experience</h2>
      ...
      <ng-container *ngIf="experience?.length; else empty">
        <div class="space-y-5">
          <div *ngFor="let exp of experience" class="flex gap-4 rounded-xl border border-gray-100 bg-gray-50 p-4">
            ...
            <div class="min-w-0 flex-1">
              <div class="flex flex-wrap items-start justify-between gap-2">
                ...
                <div class="flex items-center gap-2 text-xs text-gray-400">
                  ...
                  <span *ngIf="exp.current" class="rounded-full bg-green-100 px-2 py-1 text-green-600">Current</span>
                </div>
              </div>
