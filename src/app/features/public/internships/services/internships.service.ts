...
const MOCK_INTERNSHIPS: Internship[] = [
  {
    id: 'int-1', title: 'Frontend Developer Intern', titleAr: 'متدرب مطور واجهات أمامية', company: 'Stripe', companyAr: 'سترايب', companyLogo: 'ST',
    location: 'Bangalore, India', locationAr: 'بنغالور، الهند', locationType: 'Hybrid', duration: '3 months',
    stipend: 20000, stipendCurrency: 'INR', startDate: '2026-05-01',
    skills: ['Angular', 'TypeScript', 'Tailwind CSS'],
    skillsAr: ['Angular', 'TypeScript', 'Tailwind CSS'],
  ...
  {
    id: 'int-2', title: 'Data Science Intern', titleAr: 'متدرب علوم بيانات', company: 'Notion', companyAr: 'نوشن', companyLogo: 'NO',
    location: 'Remote', locationAr: 'عن بعد', locationType: 'Remote', duration: '6 months',
    stipend: 25000, stipendCurrency: 'INR', startDate: '2026-06-01',
    skills: ['Python', 'Pandas', 'Machine Learning', 'SQL'],
    skillsAr: ['Python', 'Pandas', 'تعلم الآلة', 'SQL'],
  ...
  {
    id: 'int-3', title: 'UI/UX Design Intern', titleAr: 'متدرب تصميم UI/UX', company: 'Figma', companyAr: 'فيجما', companyLogo: 'FI',
    location: 'San Francisco, CA', locationAr: 'سان فرانسيسكو، كاليفورنيا', locationType: 'Onsite', duration: '3 months',
    stipend: null, stipendCurrency: 'USD', startDate: '2026-07-01',
    skills: ['Figma', 'Prototyping', 'User Research'],
    skillsAr: ['Figma', 'النماذج الأولية', 'بحث المستخدم'],
  ...
  {
    id: 'int-4', title: 'Backend Engineering Intern', titleAr: 'متدرب هندسة خلفية', company: 'Vercel', companyAr: 'فيرسل', companyLogo: 'VE',
    location: 'Remote', locationAr: 'عن بعد', locationType: 'Remote', duration: '6 months',
    stipend: 30000, stipendCurrency: 'INR', startDate: '2026-05-15',
    skills: ['Node.js', 'PostgreSQL', 'REST APIs', 'Docker'],
    skillsAr: ['Node.js', 'PostgreSQL', 'واجهات REST', 'Docker'],
  ...
  {
    id: 'int-5', title: 'Marketing Intern', titleAr: 'متدرب تسويق', company: 'HubSpot', companyAr: 'هاب سبوت', companyLogo: 'HS',
    location: 'Chennai, India', locationAr: 'تشيناي، الهند', locationType: 'Hybrid', duration: '3 months',
    stipend: 12000, stipendCurrency: 'INR', startDate: '2026-05-01',
    skills: ['Content Writing', 'SEO', 'Social Media', 'Analytics'],
    skillsAr: ['كتابة المحتوى', 'SEO', 'وسائل التواصل الاجتماعي', 'التحليلات'],
  ...
  {
    id: 'int-6', title: 'Product Management Intern', titleAr: 'متدرب إدارة منتجات', company: 'Atlassian', companyAr: 'أتلاسيان', companyLogo: 'AT',
    location: 'Hyderabad, India', locationAr: 'حيدر آباد، الهند', locationType: 'Onsite', duration: '6 months',
    stipend: 22000, stipendCurrency: 'INR', startDate: '2026-06-01',
    skills: ['Product Thinking', 'Jira', 'Agile', 'Data Analysis'],
    skillsAr: ['تفكير المنتجات', 'Jira', 'Agile', 'تحليل البيانات'],
