              ...
              <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-card">
                ...
                <div class="p-8">
                  ...
                  <div class="flex items-center gap-6 flex-wrap">
                    ...
                    <span class="text-xs text-slate-400">{{ 'COURSES.DETAIL.DURATION' | translate }}: <span class="text-slate-600 font-medium">{{ course()!.duration }}</span></span>
              ...
              <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-card">
                ...
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-500">{{ 'COURSES.DETAIL.EXPERT_INSTRUCTOR' | translate:{ category: course()!.category } }}</p>
                  </div>
                </div>
              </div>
