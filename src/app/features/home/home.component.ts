...
export class HomeComponent {
  ...
  categories: JobCategory[] = [
    {
      id: '1', filterValue: 'Technology', labelKey: 'HOME.CATEGORIES.ITEMS.TECHNOLOGY', count: 284,
    ...
    {
      id: '2', filterValue: 'Design', labelKey: 'HOME.CATEGORIES.ITEMS.DESIGN', count: 97,
    ...
    {
      id: '3', filterValue: 'Marketing', labelKey: 'HOME.CATEGORIES.ITEMS.MARKETING', count: 156,
    ...
    {
      id: '4', filterValue: 'Sales', labelKey: 'HOME.CATEGORIES.ITEMS.SALES', count: 213,
    ...
    {
      id: '5', filterValue: 'Data & AI', labelKey: 'HOME.CATEGORIES.ITEMS.DATA_AI', count: 118,
    ...
    {
      id: '6', filterValue: 'Product', labelKey: 'HOME.CATEGORIES.ITEMS.PRODUCT', count: 74,
    ...
    {
      id: '7', filterValue: 'Human Resources', labelKey: 'HOME.CATEGORIES.ITEMS.HUMAN_RESOURCES', count: 89,
    ...
    {
      id: '8', filterValue: 'Finance', labelKey: 'HOME.CATEGORIES.ITEMS.FINANCE', count: 132,
